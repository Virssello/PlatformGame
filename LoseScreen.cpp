...
LoseScreen::LoseScreen(GameDataRef data,float czas) : _data(data),_czas(czas)
{
}
...
void LoseScreen::Init()
{
    ...
    texLose.loadFromFile("Rank_background_Lose.png");
    loseState.setTexture(texLose);
...
void LoseScreen::Draw()
{
    ...
    this->_data->window.draw(loseState);
